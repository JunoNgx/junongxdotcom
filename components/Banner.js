...
export default function Banner() {
    return (
        <div className="section section--banner">
            ...
            <p>I am a <strong>generalist</strong>, having worked on videogames, full-stack web applications, command tools and still exploring. Most of my works are free and open source and can be found on my GitHub, with the notable ones being listed below.</p>
        </div>
    )
}

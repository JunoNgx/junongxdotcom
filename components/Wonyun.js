...
export default function Wonyun() {
    return (
        ...
        <p>My latest videogame, launched in June 2020, is my first major dive into videogame architecture. Implementing <strong>an entity-component-system</strong>, the game is extremely scalable and flexible, and adding new features is a breeze. The minimalistic nature and limitations of <strong>Pico8</strong> (which uses a highly limited subset of Lua) made it an interesting challenge, both technically and artistically.</p>

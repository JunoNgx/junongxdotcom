...
export default function Others() {
    return (
        <div className="section section--others">
            <h2 className="section__header">Lego, photography and others</h2>
            <p>While not programming or playing videogames, you will find me enjoying arthouse cinema flicks, taking photographs, on Stud.io composing new Lego models, watching professional StarCraft, playing guitar, or soldering a new mechanical keyboard build.</p>
            <h3 className="section__subheader">Photography</h3>
            <p>A rare creative hobbies in which I enjoy the process more than more outcome, I shoot exclusively with vintage manual focus lenses and Fujifilm mechanically-inspired bodies (and occasionally dabble into film photography). I think sceneries and stills in portrait mode are highly underrated and underexplored.</p>
            ...
            <img className="section__img" src="/taccom.jpg"/>
            ...
            <p></p>
            <h3 className="section__subheader">Mechanical keyboard</h3>
            <img className="section__img" src="/keebs_in_film.jpg"/>
            <p>The highly utilitarian need to improve my sitting posture, turned out to me, was an art form with itself. Among the keycaps profiles, strange layouts, custom and lubed switches, the dangerous rabbit hole of artisans, and how an electric circuit works, mechanical keyboards offers a fascinating and endless world of self-expression.</p>

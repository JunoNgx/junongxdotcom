...
export default function EbonyMemo() {
    return (
        <div className="section section--ebonymemo">
            ...
            <p><a className="pal--b">Ebony Memo</a> is an arthouse videogame curator website for mobile devices. This is <a className="pal--g">a custom content management system</a> consisting of three parts:</p>

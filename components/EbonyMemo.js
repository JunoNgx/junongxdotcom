...
const URL_LOCAL = {
    ...
    frontend_deployment: "http://www.ebonymemo.com/"
}
...
export default function EbonyMemo() {
    return (
        <div className="section section--ebonymemo">
            ...
            <p>Ebony Memo is a videogame curator website for mobile devices. This is a custom content management system consisting of three parts:</p>
            ...
            <p><strong>Content delivery application</strong> (NextJS, <CA link={URL_LOCAL.frontend_source}>source</CA>, <CA link={URL_LOCAL.frontend_deployment}>deployment</CA>): The only publicized user-facing component of the system. The vast majority of the content is server-side rendered.</p>
        </div>
    )
}

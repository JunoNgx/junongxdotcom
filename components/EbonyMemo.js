...
export default function EbonyMemo() {
    return (
        <div className="section section--ebonymemo">
            ...
            <p><strong>Frontend</strong> (NextJS, <CA link={URL_LOCAL.frontend_source}>source</CA>, <CA link={URL_LOCAL.frontend_deployment}>deployment</CA>): The only publicised user-facing portion of the system. The vast majority of the content is server-side rendered.</p>
        </div>
    )
}

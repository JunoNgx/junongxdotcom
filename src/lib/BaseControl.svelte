        ...
        .control__settings
            ...
            .control__settings-dark-mode
                .control__settings-dark-mode-container(on:click!="{switchDarkMode}")
                    ...
                    button.control__settings-dark-mode-button(aria-label="Dark mode: OS Settings")
                        // Gear
                    ...
                    button.control__settings-dark-mode-button(aria-label="Dark mode: Light")
                        // The sun
                    ...
                    button.control__settings-dark-mode-button(aria-label="Dark mode: Dark")
                        // The moon
